...
public class WelcomeController {
	...
	public String confirmacionPagoPasarela(
			@RequestParam Map<String, Object> request,
			HttpServletRequest request2) {
		String respuesta = "200";
		System.out
				.println("------------->Inicio llamada a WS de Confirmacion:");
		System.out.println("Map: " + request);
		System.out.println("----------->detailed Map");
		for (String key : request.keySet()) {
			System.out.println("--->" + key + ":\t\t\t" + request.get(key));
		 ...
		 * RequestConfirmacionPayu confirm = mapper.convertValue(request,
		 * RequestConfirmacionPayu.class); System.out.println("POJO: " +
		 * confirm);
		 */
		return respuesta;
	}
